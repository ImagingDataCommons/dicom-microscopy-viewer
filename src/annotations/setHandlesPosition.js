...
const getHelperLine = (baseData, proposedPoint, vector) => {
  ...
  // Create a helper line to find the intersection point in the long line
...
const moveShortAxis = (
  ...
  const previousCoordinates = shortAxisGeometry.getCoordinates();
  shortAxisGeometry.setProperties({ previousCoordinates }, true);
